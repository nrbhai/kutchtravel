  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-100 to-zinc-50 selection:bg-gray-300 selection:text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative w-full max-w-md">
              <input
                ...
                className="w-full px-6 py-4 bg-white/10 backdrop-blur-xl text-gray-900 border border-gray-200 rounded-full focus:ring-2 focus:ring-gray-400 focus:border-gray-400 outline-none shadow-xl transition-all duration-300 placeholder-gray-300/70 font-poppins"
              />
        ...
        >
          <p className="text-lg font-poppins font-semibold text-gray-600">
        ...
        {filteredDestinations.length > 0 ? (
            ...
            {filteredDestinations.map((destination, index) => (
              ...
              >
                <Link href={`/destinations/${destination.slug}`}>
                  <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white/10 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 hover:scale-[1.02] hover:bg-white/15 hover:border-white/30">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="bg-gradient-to-r from-gray-500 to-gray-600 text-gray-900 px-4 py-2 rounded-full text-sm font-semibold shadow-lg backdrop-blur font-poppins">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                        <p className="text-gray-900 text-sm font-medium drop-shadow-lg font-poppins">
                          Click to explore →
                        </p>
                      </div>
                    </div>
                    ...
                    {/* Content Section */}
                    <div className="p-6">
                      <h3 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-gray-300 mb-3 group-hover:from-gray-200 group-hover:to-gray-200 transition-all duration-300 drop-shadow-sm font-sora">
                        {destination.title}
                      </h3>
                      <p className="text-gray-700 mb-6 line-clamp-3 leading-relaxed font-poppins">
                        {destination.description}
                      </p>

                      {/* Travel Info with Gradient Background */}
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="bg-white/10 backdrop-blur-xl rounded-lg p-3 border border-gray-200">
                          <span className="font-semibold text-gray-600 text-sm block mb-1 font-sora">Best Time</span>
                          <p className="text-gray-600 text-sm font-poppins">{destination.bestTime}</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-xl rounded-lg p-3 border border-gray-200">
                          <span className="font-semibold text-gray-600 text-sm block mb-1 font-sora">Duration</span>
                          <p className="text-gray-600 text-sm font-poppins">{destination.duration}</p>
                        </div>
                      </div>

                      {/* Highlights */}
                      <div className="mb-4">
                        <h4 className="font-semibold text-gray-900 mb-3 text-sm font-sora">Highlights</h4>
                        <div className="flex flex-wrap gap-2">
                          {destination.highlights.slice(0, 3).map((highlight, idx) => (
                            <span 
                              key={idx}
                              className="text-xs px-3 py-1 bg-white/10 backdrop-blur-xl text-gray-600 rounded-full border border-gray-200 font-poppins"
                            >
                              {highlight}
                            </span>
                          ))}
                          {destination.highlights.length > 3 && (
                            <span className="text-xs px-3 py-1 bg-white/5 backdrop-blur-xl text-gray-600 rounded-full border border-white/10 font-poppins">
                      ...
                      <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                        ...
                        <div className="bg-gradient-to-r from-gray-600 to-gray-600 text-gray-900 text-sm font-semibold px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all duration-300 shadow-lg">
                          Explore →
                        </div>
                      </div>
                    </div>
          ...
          >
            <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-gray-100/80 to-gray-100/80 dark:from-gray-900/80 dark:to-gray-900/80 rounded-full flex items-center justify-center backdrop-blur">
              <svg className="w-12 h-12 text-gray-800 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 dark:from-gray-100 dark:via-gray-100 dark:to-gray-100 mb-4 drop-shadow-sm">
            ...
            <button
              ...
              className="bg-gradient-to-r from-gray-600 to-gray-600 hover:from-gray-700 hover:to-gray-700 text-gray-900 px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Reset Filters
            </button>
          </motion.div>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 py-20">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 dark:from-gray-800 dark:via-gray-800 dark:to-gray-800 drop-shadow-[0_6px_18px_rgba(0,0,0,0.18)] emboss-text display-heading mb-6">
            Plan Your Kutch Adventure
          </h2>
          <p className="text-xl md:text-2xl font-lora font-semibold text-gray-600 dark:text-gray-300 drop-shadow-[0_6px_14px_rgba(0,0,0,0.12)] tracking-wide mb-8">
