  ...
  sections: [
    {
      heading: "Overview",
      color: "#f0fff7ff",
      border: "border-l-4 border-white-500 text-white-600",
    ...
    },
    {
      ...
      border: "border-l-4 border-gray-500 text-gray-700",
      list: [
        "<b><a href='/places/kotay-surya-mandir' class='text-gray-300 hover:text-gray-300 underline'>Kotay Surya Mandir:</a></b> 22km - Ancient 10th century Sun temple ruins with archaeological significance",
        "<b><a href='/places/dhrang-mekan-dada' class='text-gray-300 hover:text-gray-300 underline'>Dhrang - Mekan Dada:</a></b> 25km - Sacred shrine and pilgrimage site",
        "<b><a href='/places/abjibapa-chhatardi' class='text-gray-300 hover:text-gray-300 underline'>Abjibapa ni Chatardi Baladia:</a></b> 20km - Historical cenotaph and heritage site",
        "<b><a href='/places/rudramata-dam' class='text-gray-300 hover:text-gray-300 underline'>Rudramata Dam:</a></b> 15km - Scenic dam with water reservoir and peaceful surroundings",
        "<b><a href='/places/gangeshwar-mahadev' class='text-gray-300 hover:text-gray-300 underline'>Gangeshwar Mahadev:</a></b> 10km - Temple on hill with vast trekking opportunities and panoramic views",
        "<b><a href='/places/vande-mataram-memorial' class='text-gray-300 hover:text-gray-300 underline'>Vande Mataram Memorial:</a></b> 8km - Memorial at Bhujodi village commemorating freedom struggle",
        "<b><a href='/places/jadura' class='text-gray-300 hover:text-gray-300 underline'>Jadura:</a></b> 5km - Scenic sunset point with panoramic views",
        "<b><a href='/places/hanuman-tekri' class='text-gray-300 hover:text-gray-300 underline'>Hanuman Tekri Kodki:</a></b> 10km - Hanuman temple and excellent sunset viewpoint"
      ]
    },
    {
