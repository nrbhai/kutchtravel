...
export default function Home() {
    ...
    <main className="scroll-smooth selection:bg-gray-300 selection:text-gray-900 relative text-gray-900 dark:bg-gray-950 dark:text-gray-900">
      ...
      <section id="home" className="relative h-[100svh] min-h-[560px] flex flex-col justify-center items-center text-center overflow-hidden">
        ...
        >
          <motion.h1 variants={fadeUp} className="font-sora leading-tight tracking-tight">
            ...
            <motion.span 
              variants={fadeUp} 
              className="block text-2xl md:text-3xl lg:text-4xl font-poppins font-medium bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mt-6 drop-shadow-[0_6px_14px_rgba(0,0,0,0.3)] tracking-wide sparkle-wrap" 
              tabIndex={0}
            >
          ...
          <motion.div variants={fadeUp} className="mt-10 flex flex-wrap justify-center gap-5">
            ...
            <a 
              href="#quick-guide" 
              className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 text-white font-poppins font-medium py-4 px-8 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-white/20"
            >
      ...
      <section id="quick-guide" className="relative overflow-hidden py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="mb-8">
              <span className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full text-sm font-poppins font-semibold tracking-wide shadow-lg shadow-purple-500/30">
                <span>🗺️</span>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
              <div className="flex items-center gap-2 text-slate-700 font-poppins font-medium">
                <span className="w-3 h-3 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full animate-pulse"></span>
                <span className="text-sm">Expert Tips</span>
              </div>
              <div className="w-px h-5 bg-gradient-to-b from-indigo-400 to-purple-400"></div>
              <div className="flex items-center gap-2 font-poppins font-medium">
                <span className="w-3 h-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-full animate-pulse"></span>
                <span className="text-sm text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">Local Insights</span>
              </div>
              <div className="w-px h-5 bg-gradient-to-b from-indigo-400 via-purple-400 to-pink-400"></div>
              <div className="flex items-center gap-2 font-poppins font-medium">
                <span className="w-3 h-3 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 rounded-full animate-pulse"></span>
          ...
          >
            ...
            <div className="frosted-glass rounded-[2rem] shadow-2xl border-2 border-white/20 p-10 md:p-14 relative overflow-hidden bg-white/10">
              ...
              <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-full opacity-20 blur-3xl"></div>
              <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-gradient-to-br from-cyan-600 via-blue-600 to-indigo-600 rounded-full opacity-20 blur-3xl"></div>
  ...
  <div className="h-px w-full bg-gradient-to-r from-transparent via-indigo-400 via-60% to-transparent" />
      </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-poppins font-light">
              ...
              <span className="block mt-2 text-slate-900 font-medium">natural beauty, and cultural significance.</span>
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
              ...
              <div className="w-px h-5 bg-gradient-to-b from-gray-400 to-gray-500"></div>
              <div className="flex items-center gap-2 text-slate-800 font-poppins font-medium">
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-72 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-indigo-900/80 via-purple-900/30 to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/40 via-purple-600/20 to-pink-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                    
                    {/* Premium Category Badge */}
                    <div className="absolute top-5 right-5 z-10">
                      <div className="bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 text-white px-5 py-2.5 rounded-full shadow-2xl backdrop-blur-sm border-2 border-white/30 font-poppins">
                    ...
                    <div className="absolute top-5 left-5 opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100 z-10">
                      <div className="w-14 h-14 bg-gradient-to-r from-white/95 to-white/80 backdrop-blur-md rounded-full shadow-2xl flex items-center justify-center border-2 border-white/50 hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600 hover:text-white transition-all duration-300">
                    ...
                    <div className="absolute bottom-5 left-5 right-5 z-10">
                      <h3 className="text-3xl font-sora font-bold mb-2 leading-tight deep-shadow text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600">
                        {destination.title}
                      </h3>
                      <div className="flex items-center gap-2 text-white/90">
                        <span className="text-sm">📍</span>
                        <span className="text-sm font-poppins font-medium bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 bg-clip-text text-transparent">Kutch, Gujarat</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-7 bg-white/90 backdrop-blur-xl border-t border-purple-100">
                    <p className="text-slate-800 font-poppins text-sm leading-relaxed mb-5 line-clamp-3 group-hover:text-gray-900 transition-colors">
          ...
          >
            <Link
              href="/destinations"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl border border-white/20"
            >
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-indigo-50 via-purple-50 to-pink-50">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            <div className="mb-6">
              <span className="inline-block px-4 py-2 bg-gradient-to-r from-gray-700 to-gray-800 rounded-full text-gray-900 font-poppins font-medium text-sm border border-purple-200 mb-6">
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-poppins font-light max-w-4xl mx-auto leading-relaxed mb-8">
              ...
              <span className="text-slate-900 font-medium">and every craft carries centuries of heritage.</span>
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="space-y-8">
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="relative bg-gradient-to-br from-gray-100 to-gray-100 rounded-2xl p-8 border-2 border-purple-200 hover:border-gray-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                >
                  <div className="relative bg-gradient-to-br from-gray-100 to-gray-100 rounded-2xl p-8 border-2 border-white/20 hover:border-gray-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-gray-400 to-gray-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-gray-900">🟡</span>
                      </div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-gradient-to-br from-white/80 via-gray-50/80 to-gray-50/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/50">
              <h3 className="text-3xl font-bold text-gray-900 mb-6 text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 emboss-text">
                Living Heritage
              </h3>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
      ...
      <section id="guide" className="relative overflow-hidden py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="mb-6">
              <span className="inline-block px-6 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full text-sm font-poppins font-semibold tracking-wide border border-purple-200 shadow-lg">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="bg-gray-500/20 p-4 rounded-2xl border border-purple-200/30">
