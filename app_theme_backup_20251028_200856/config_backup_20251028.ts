...
export const theme = {
  ...
  colors: {
    // Background gradients
      gradients: {
        primary: 'from-indigo-700 via-purple-700 to-pink-700',
        secondary: 'from-cyan-700 via-blue-700 to-indigo-700',
        accent: 'from-pink-600 via-purple-600 to-indigo-600',
        light: 'from-indigo-50 via-purple-50 to-pink-50',
    },
    
    // Text colors
      text: {
        primary: 'text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600',
        secondary: 'text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600',
    ...
    // Badge/Button colors
    badges: {
      primary: 'from-gray-500 to-gray-500',
      secondary: 'from-gray-500 to-gray-500',
