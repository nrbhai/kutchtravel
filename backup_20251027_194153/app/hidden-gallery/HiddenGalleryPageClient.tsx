...
export default function HiddenGalleryPageClient() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-emerald-800 via-teal-600 to-cyan-600 py-16">
        {/* Background Pattern */}
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-8 mt-8">
              <div className="text-center">
                ...
                <div className="text-emerald-200 text-sm">Secret Photos</div>
              </div>
              <div className="w-px h-12 bg-emerald-300"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">🤫</div>
                <div className="text-emerald-200 text-sm">Hidden Gems</div>
              </div>
              <div className="w-px h-12 bg-emerald-300"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-white">🗺️</div>
                <div className="text-emerald-200 text-sm">Uncharted</div>
              </div>
            </div>
          </div>
        </div>
