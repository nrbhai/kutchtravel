    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-700 via-purple-700 to-blue-700 selection:bg-purple-200 selection:text-purple-900">
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4 py-20">
          ...
          <p className="text-lg md:text-xl font-lora font-semibold text-purple-300 dark:text-blue-300 drop-shadow-[0_6px_14px_rgba(0,0,0,0.12)] tracking-wide mb-8">
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-purple-100 max-w-2xl mx-auto text-base">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-purple-400/50">
        <div className="text-center mb-6">
          ...
          <p className="text-purple-100 text-sm">Powered by Booking.com</p>
        </div>
        
        {/* Booking.com Widget Placeholder */}
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-8 border-2 border-dashed border-purple-400">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                <span className="text-purple-300 font-semibold">{hotel.price}</span>
                <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-sm">★ {hotel.rating}</span>
              </div>
            </div>
          </motion.div>
        ))}
...
function FlightsSection() {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-purple-400/50">
        <div className="text-center mb-6">
          <h3 className="text-2xl font-semibold text-white mb-2">Search Flights</h3>
          <p className="text-purple-100">Powered by Skyscanner</p>
        </div>
...
function ToursSection() {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-purple-400/50">
        <div className="text-center mb-6">
          <h3 className="text-2xl font-semibold text-white mb-2">Book Tours & Activities</h3>
          <p className="text-purple-100">Powered by GetYourGuide</p>
        </div>
        
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-8 border-2 border-dashed border-purple-200">
          <p className="text-center text-purple-100 mb-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[
          ...
          >
            ...
            <div className="space-y-2 text-sm text-purple-100 mb-4">
...
function ShoppingSection() {
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          >
            ...
            <a 
              href={item.link}
              className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-colors text-sm"
            >
              Shop Now →
            </a>
          </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: index * 0.1 }}
              className="border border-white/20 rounded-lg overflow-hidden hover:shadow-lg transition-shadow"
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-purple-200 line-through">{product.originalPrice}</span>
                </div>
                <div className="flex justify-between items-center text-sm text-purple-100 mb-3">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-purple-100">
