...
export default function Home() {
  ...
  return (
    <main className="scroll-smooth selection:bg-blue-200 selection:text-purple-300 relative text-white dark:bg-gray-950 dark:text-gray-100">
      <Navigation />
      ...
      <section id="home" className="relative h-[100svh] min-h-[560px] flex flex-col justify-center items-center text-center overflow-hidden">
        ...
        >
          <motion.h1 variants={fadeUp} className="font-sora leading-tight tracking-tight">
            ...
            <motion.span 
              variants={fadeUp} 
              className="block text-2xl md:text-3xl lg:text-4xl font-poppins font-medium bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 bg-clip-text text-transparent mt-6 drop-shadow-[0_6px_14px_rgba(0,0,0,0.3)] tracking-wide sparkle-wrap" 
              tabIndex={0}
            >
          ...
          <motion.p variants={fadeUp} className="mt-8 text-2xl md:text-3xl lg:text-4xl max-w-4xl mx-auto font-space-grotesk font-medium leading-relaxed">
            <span className="text-white font-bold drop-shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
              Where salt meets sky, and stories meet silence
            </span>
            <span className="block text-lg md:text-xl lg:text-2xl mt-6 font-poppins font-light text-gray-200">
          ...
          <motion.div variants={fadeUp} className="mt-10 flex flex-wrap justify-center gap-5">
            ...
            <a 
              href="#quick-guide" 
              className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-xl text-white font-poppins font-medium py-4 px-8 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-white/30 hover:bg-white/20"
            >
        ...
        <motion.div 
          ...
          className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white text-3xl z-20"
        >
          ↓
        </motion.div>
      </section>
      ...
      <section id="quick-guide" className="relative overflow-hidden py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="mb-8">
              <span className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-full text-sm font-poppins font-semibold tracking-wide shadow-lg shadow-indigo-500/30">
                <span>🗺️</span>
            ...
            <p className="text-xl md:text-2xl text-purple-200 max-w-3xl mx-auto leading-relaxed font-poppins font-light">
              Local-first insights to plan the perfect trip across seasons and regions. 
              <span className="block mt-2 text-pink-300 font-medium">Get expert guidance for an authentic Kutch experience.</span>
            </p>
            
            {/* Decorative Elements */}
            <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
              <div className="flex items-center gap-2 text-purple-200 font-poppins font-medium">
                <span className="w-3 h-3 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full animate-pulse"></span>
                <span className="text-sm">Expert Tips</span>
              </div>
              <div className="w-px h-5 bg-gradient-to-b from-purple-300 to-pink-300"></div>
              <div className="flex items-center gap-2 text-purple-200 font-poppins font-medium">
              ...
              <div className="w-px h-5 bg-gradient-to-b from-purple-300 to-pink-300"></div>
              <div className="flex items-center gap-2 text-purple-200 font-poppins font-medium">
                <span className="w-3 h-3 bg-gradient-to-r from-pink-400 to-blue-400 rounded-full animate-pulse"></span>
          ...
          >
            ...
            <div className="frosted-glass rounded-[2rem] shadow-2xl border-2 border-white/20 p-10 md:p-14 relative overflow-hidden bg-white/10">
              {/* Decorative gradient orb */}
              <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full opacity-20 blur-3xl"></div>
              <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-full opacity-20 blur-3xl"></div>
          ...
          >
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white px-10 py-5 rounded-full font-poppins font-bold text-lg shadow-2xl border-2 border-white/20 hover:scale-105 transition-transform duration-300 cursor-default">
              <span className="text-2xl">🧭</span>
              <span>Ready to explore? Plan your perfect Kutch journey</span>
              <span className="text-2xl">✨</span>
            </div>
            <p className="text-purple-200 font-poppins text-base mt-6">Expert recommendations for every season and interest</p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="h-px w-full bg-gradient-to-r from-transparent via-indigo-300 to-transparent" />
      </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-purple-200 max-w-3xl mx-auto leading-relaxed font-poppins font-light">
              ...
              <span className="block mt-2 text-pink-300 font-medium">natural beauty, and cultural significance.</span>
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
              ...
              <div className="w-px h-5 bg-gradient-to-b from-blue-300 to-indigo-300"></div>
              <div className="flex items-center gap-2 text-cyan-700 font-poppins font-medium">
                <span className="w-3 h-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full animate-pulse"></span>
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-72 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-600/40 via-transparent to-blue-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                    
                    {/* Premium Category Badge */}
                    <div className="absolute top-5 right-5 z-10">
                      <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-white px-5 py-2.5 rounded-full shadow-2xl backdrop-blur-sm border-2 border-white/30 font-poppins">
                    ...
                    <div className="absolute top-5 left-5 opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-75 group-hover:scale-100 z-10">
                      <div className="w-14 h-14 bg-gradient-to-r from-white/95 to-white/80 backdrop-blur-md rounded-full shadow-2xl flex items-center justify-center border-2 border-white/50 hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-500 hover:text-white transition-all duration-300">
                        <span className="text-purple-600 hover:text-white text-xl font-bold">→</span>
                      </div>
                    </div>

                    {/* Title Overlay */}
                    <div className="absolute bottom-5 left-5 right-5 z-10">
                      <h3 className="text-3xl font-sora font-bold text-white mb-2 leading-tight deep-shadow">
                        {destination.title}
                      </h3>
                  ...
                  <div className="p-7 bg-white/20 backdrop-blur-xl border-t border-white/20">
                    <p className="text-purple-100 font-poppins text-sm leading-relaxed mb-5 line-clamp-3 group-hover:text-white transition-colors">
                    ...
                    <div className="flex items-center justify-between pt-5 border-t border-white/20">
                      <span className="inline-flex items-center gap-2 text-purple-300 hover:text-pink-300 font-poppins font-bold text-sm">
                        <span>Explore More</span>
                        <span className="transform group-hover:translate-x-2 transition-transform duration-300">→</span>
                      </span>
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 bg-purple-500/30 rounded-full flex items-center justify-center">
                          <span className="text-xs">✨</span>
                        </div>
                        <span className="text-xs font-poppins font-semibold text-purple-200">Featured</span>
                      </div>
                    </div>
                  </div>
                </motion.article>
          ...
          >
            <Link
              href="/destinations"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-500 via-indigo-500 to-cyan-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-blue-600 hover:via-indigo-600 hover:to-cyan-600 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl border border-white/20"
            >
              <span>View All Destinations</span>
              <span className="transform group-hover:translate-x-1 transition-transform">→</span>
            </Link>
            <p className="text-purple-100 text-sm mt-4">Discover all 12+ amazing places in Kutch</p>
          </motion.div>
        </div>
      </section>
      ...
      <section id="culture" className="relative overflow-hidden py-24">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-700 via-purple-700 to-blue-700">
          <div className="blob blob-1 w-[500px] h-[500px] top-0 left-0 opacity-30"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            <div className="mb-6">
              <span className="inline-block px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full text-white font-poppins font-medium text-sm border border-indigo-400 mb-6">
            ...
            <p className="text-xl md:text-2xl text-purple-200 font-poppins font-light max-w-4xl mx-auto leading-relaxed mb-8">
              Immerse yourself in the vibrant world of Kutchi traditions, where every thread tells a story 
              <br className="hidden md:block" />
              <span className="text-pink-300 font-medium">and every craft carries centuries of heritage.</span>
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="space-y-8">
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <div className="relative bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl p-8 border-2 border-purple-400 hover:border-blue-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">🔴</span>
                      </div>
                      <h3 className="font-bold text-purple-300 mb-2">Bandhani</h3>
                      <p className="text-xs text-purple-300">Tie-dye artistry with intricate dot patterns</p>
                      <p className="text-xs text-pink-300 mt-2 opacity-75">Click to learn more</p>
                    </div>
                ...
                >
                  <div className="relative bg-gradient-to-br from-indigo-100 to-cyan-100 rounded-2xl p-8 border-2 border-purple-400 hover:border-indigo-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-indigo-400 to-cyan-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">🔵</span>
                      </div>
                      <h3 className="font-bold text-purple-300 mb-2">Ajrakh</h3>
                      <p className="text-xs text-purple-300">Block-printed geometric masterpieces</p>
                      <p className="text-xs text-pink-300 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-indigo-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
                </div>
                ...
                >
                  <div className="relative bg-gradient-to-br from-cyan-100 to-blue-100 rounded-2xl p-8 border-2 border-cyan-200 hover:border-cyan-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">🟡</span>
                      </div>
                      <h3 className="font-bold text-cyan-800 mb-2">Rogan Art</h3>
                      <p className="text-xs text-cyan-600">Painted fabric with castor oil colors</p>
                      <p className="text-xs text-cyan-500 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-cyan-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
                </div>
                ...
                >
                  <div className="relative bg-gradient-to-br from-indigo-100 to-blue-100 rounded-2xl p-8 border-2 border-purple-400 hover:border-indigo-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-indigo-400 to-blue-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">✨</span>
                      </div>
                      <h3 className="font-bold text-purple-300 mb-2">Mirror Work</h3>
                      <p className="text-xs text-purple-300">Shisha embroidery with tiny mirrors</p>
                      <p className="text-xs text-pink-300 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-indigo-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                ...
                >
                  <div className="relative bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl p-8 border-2 border-amber-200 hover:border-amber-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-amber-400 to-orange-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">🔪</span>
                      </div>
                      <h3 className="font-bold text-amber-800 mb-2">Sudi Chappu</h3>
                      <p className="text-xs text-amber-600">Traditional knife-making in Anjar</p>
                      <p className="text-xs text-amber-500 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-amber-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
                </div>
                ...
                >
                  <div className="relative bg-gradient-to-br from-red-100 to-rose-100 rounded-2xl p-8 border-2 border-red-200 hover:border-red-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-red-400 to-rose-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">🏺</span>
                      </div>
                      <h3 className="font-bold text-red-800 mb-2">Pottery</h3>
                      <p className="text-xs text-red-600">Clay craft traditions across villages</p>
                      <p className="text-xs text-red-500 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-red-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
                </div>
                ...
                >
                  <div className="relative bg-gradient-to-br from-yellow-100 to-amber-100 rounded-2xl p-8 border-2 border-yellow-200 hover:border-yellow-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-yellow-400 to-amber-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">👜</span>
                      </div>
                      <h3 className="font-bold text-yellow-800 mb-2">Leather Craft</h3>
                      <p className="text-xs text-yellow-600">Traditional leather working</p>
                      <p className="text-xs text-yellow-500 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-yellow-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
                </div>
                ...
                >
                  <div className="relative bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl p-8 border-2 border-green-200 hover:border-green-300 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg">
                        <span className="text-2xl text-white">🧵</span>
                      </div>
                      <h3 className="font-bold text-green-800 mb-2">Weaving</h3>
                      <p className="text-xs text-green-600">Handloom textiles and carpets</p>
                      <p className="text-xs text-green-500 mt-2 opacity-75">Click to learn more</p>
                    </div>
                    <div className="absolute inset-0 bg-gradient-to-t from-green-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl"></div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-gradient-to-br from-white/80 via-blue-50/80 to-purple-50/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/50">
              <h3 className="text-3xl font-bold text-white mb-6 text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-800 emboss-text">
                Living Heritage
              </h3>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <span className="text-white text-lg">🏛️</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-white mb-1">Artisan Villages</h4>
                    <p className="text-purple-100 text-sm leading-relaxed">Visit Bhujodi, Nirona, and Dhamadka where master craftsmen preserve ancient techniques passed down through generations.</p>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-indigo-400 to-cyan-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <span className="text-white text-lg">🎭</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-white mb-1">Festival Celebrations</h4>
                    <p className="text-purple-100 text-sm leading-relaxed">Experience Rann Utsav and Navratri where folk dances, music, and cultural performances light up the desert nights.</p>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <span className="text-white text-lg">🛍️</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-white mb-1">Authentic Shopping</h4>
                    <p className="text-purple-100 text-sm leading-relaxed">Discover unique handicrafts, textiles, and pottery directly from local artisans in traditional markets and cooperative societies.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/20">
                <Link 
                  href="/culture" 
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-full font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 hover:scale-105 shadow-lg"
                >
      ...
      <section id="guide" className="relative overflow-hidden py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            <div className="mb-6">
              <span className="inline-block px-6 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-full text-sm font-poppins font-semibold tracking-wide border border-indigo-400 shadow-lg">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto leading-relaxed font-poppins font-light">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <div className="flex items-center gap-2 text-purple-200 font-poppins">
              ...
              <div className="w-px h-4 bg-purple-300"></div>
              <div className="flex items-center gap-2 text-purple-200 font-poppins">
                <span className="w-2 h-2 bg-gradient-to-r from-pink-400 to-blue-400 rounded-full animate-pulse"></span>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              variants={fadeUp}
              className="bg-white/20 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-500"
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center">
                  <span className="text-white text-2xl">🗓️</span>
                </div>
                <h3 className="text-2xl font-sora font-bold text-white">Best Time</h3>
              </div>
              <div className="space-y-4">
                <div className="bg-indigo-500/20 p-4 rounded-2xl border border-indigo-400/30">
                  <h4 className="font-poppins font-bold text-indigo-200 mb-2">November - February</h4>
                  <p className="text-sm text-purple-100 font-poppins">Perfect weather, Rann Utsav festival, ideal for desert camping</p>
                </div>
                <div className="bg-purple-500/20 p-4 rounded-2xl border border-purple-400/30">
                  <h4 className="font-poppins font-bold text-purple-200 mb-2">March - April</h4>
                  <p className="text-sm text-purple-100 font-poppins">Mild temperatures, fewer crowds, great for photography</p>
                </div>
                <div className="bg-pink-500/20 p-4 rounded-2xl border border-pink-400/30">
                  <h4 className="font-poppins font-bold text-pink-200 mb-2">May - September</h4>
                  <p className="text-sm text-purple-100 font-poppins">Hot & humid, monsoon season, avoid this period</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-sora font-bold text-white">How to Reach</h3>
              </div>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-poppins font-semibold text-white">By Air</h4>
                    <p className="text-sm text-purple-100 font-poppins">Bhuj Airport (1 hr from Rann), Ahmedabad (4-5 hrs drive)</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-poppins font-semibold text-white">By Train</h4>
                    <p className="text-sm text-purple-100 font-poppins">Bhuj Railway Station, Gandhidham Junction</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-poppins font-semibold text-white">By Road</h4>
                    <p className="text-sm text-purple-100 font-poppins">Well-connected highways from major Gujarat cities</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-sora font-bold text-white">What to Pack</h3>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-3 text-sm font-poppins">
                  <span className="w-2 h-2 bg-indigo-400 rounded-full"></span>
                  <span className="text-purple-100">Layered clothing for temperature changes</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-poppins">
                  <span className="w-2 h-2 bg-purple-400 rounded-full"></span>
                  <span className="text-purple-100">Comfortable walking shoes</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-poppins">
                  <span className="w-2 h-2 bg-pink-400 rounded-full"></span>
                  <span className="text-purple-100">Sunscreen & sunglasses</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-poppins">
                  <span className="w-2 h-2 bg-blue-400 rounded-full"></span>
                  <span className="text-purple-100">Camera with extra batteries</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-poppins">
                  <span className="w-2 h-2 bg-indigo-300 rounded-full"></span>
                  <span className="text-purple-100">Water bottle & snacks</span>
                </div>
                <div className="flex items-center gap-3 text-sm font-poppins">
                  <span className="w-2 h-2 bg-purple-300 rounded-full"></span>
                  <span className="text-purple-100">First aid kit & medications</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            variants={fadeUp}
            className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-8 text-white shadow-xl mb-16"
          >
            <div className="text-center mb-8">
              ...
              <p className="text-purple-100 text-lg font-poppins">Stay safe and make the most of your Kutch adventure</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                ...
                <p className="text-sm text-purple-100 font-poppins">Monitor weather conditions, especially during monsoon</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                <div className="text-3xl mb-3">📱</div>
                <h4 className="font-poppins font-bold mb-2">Stay Connected</h4>
                <p className="text-sm text-purple-100 font-poppins">Keep emergency contacts, local network may be limited</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                <div className="text-3xl mb-3">💧</div>
                <h4 className="font-poppins font-bold mb-2">Stay Hydrated</h4>
                <p className="text-sm text-purple-100 font-poppins">Carry plenty of water, desert climate can be dehydrating</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20">
                <div className="text-3xl mb-3">🗺️</div>
                <h4 className="font-poppins font-bold mb-2">Local Guide</h4>
                <p className="text-sm text-purple-100 font-poppins">Consider hiring local guides for remote areas</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white/20 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-white/20">
              <h3 className="text-3xl font-sora font-bold text-white mb-4">Need Personalized Guidance?</h3>
              <p className="text-purple-100 font-poppins mb-8 max-w-2xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Link
                  href="/about"
                  className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-8 py-4 rounded-full font-poppins font-bold text-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 hover:scale-105 shadow-xl flex items-center gap-2"
                >
                  <span>📞</span>
                ...
                <Link
                  href="/destinations"
                  className="bg-white/10 text-white border-2 border-white/30 px-8 py-4 rounded-full font-poppins font-bold text-lg hover:bg-white/20 transition-colors shadow-lg flex items-center gap-2 backdrop-blur-sm"
                >
                  <span>🗺️</span>
      ...
      <section id="contact" className="relative overflow-hidden py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-purple-200 max-w-4xl mx-auto leading-relaxed font-poppins font-light">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
                <h3 className="text-3xl font-sora font-bold text-white mb-6 flex items-center gap-3">
                  <span className="text-4xl">🌟</span>
                  What You'll Get
                </h3>
                <ul className="space-y-4 text-lg text-purple-100 font-poppins">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a
                  ...
                  className="flex items-center justify-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                ...
                <motion.a
                  href="/about"
                  className="flex items-center justify-center gap-3 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white px-8 py-4 rounded-2xl font-bold text-lg border border-white/30 hover:border-white/50 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <span className="text-2xl">🎯</span>
            ...
            >
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
                ...
                <p className="text-blue-100/80 text-center mt-4 text-sm">
      ...
      <footer className="relative overflow-hidden">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-400 via-pink-500 to-blue-600"></div>
        ...
        <div className="relative pt-20 pb-12">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              <div className="lg:col-span-2">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h3 className="text-4xl font-sora font-extrabold bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 bg-clip-text text-transparent mb-6">
                    Travel Kutch
                  </h3>
                  <p className="text-lg text-purple-100 leading-relaxed mb-8 max-w-md font-poppins">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <a 
                      href="https://wa.me/919825034580" 
                      className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 hover:scale-105"
                    >
                      💬 WhatsApp
                    </a>
                    <a 
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h4 className="text-2xl font-sora font-bold text-white mb-6">Explore</h4>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h4 className="text-2xl font-sora font-bold text-white mb-6">Connect</h4>
                <div className="space-y-4 font-poppins">
                  ...
                  <div className="flex items-center gap-3 text-purple-200">
                    ...
                    <div>
                      ...
                      <a href="tel:+919825034580" className="hover:text-pink-300 transition-colors text-sm">+91 98250 34580</a>
                      <br />
                      <a href="tel:+919512234395" className="hover:text-pink-300 transition-colors text-sm">+91 95122 34395</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-purple-200">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@travelkutch.com" className="hover:text-pink-300 transition-colors text-sm">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h4 className="text-3xl font-bold text-center bg-gradient-to-r from-white via-cyan-200 to-blue-300 bg-clip-text text-transparent mb-8 font-playfair emboss-text">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
                  ...
                  <p className="text-blue-100/80 text-center mt-4">
            ...
            <div className="border-t border-white/20 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <motion.p 
                  className="text-blue-200/80 text-center md:text-left"
                  initial={{ opacity: 0 }}
                  whileInView={{ opacity: 1 }}
                  transition={{ duration: 0.6, delay: 0.4 }}
                  viewport={{ once: true }}
                >
                  © {new Date().getFullYear()} <span className="text-cyan-300 font-semibold">Travel Kutch</span>. 
        ...
        {selectedTextile && (
          ...
          >
            <motion.div
              ...
              className="bg-white/20 backdrop-blur-xl rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
              ...
              {selectedTextile && textileInfo[selectedTextile as keyof typeof textileInfo] && (
                <div className="p-8">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <button
                      onClick={() => setSelectedTextile(null)}
                      className="w-10 h-10 bg-white/20 backdrop-blur-xl hover:bg-white/20 backdrop-blur-xl rounded-full flex items-center justify-center transition-colors"
                    >
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="grid gap-3">
                      {textileInfo[selectedTextile as keyof typeof textileInfo].details.map((detail, index) => (
                        <div key={index} className="flex items-start gap-3 p-3 bg-purple-500/20 rounded-lg">
                          <span className="text-purple-300 text-sm font-medium">{detail}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-100 to-indigo-100 p-6 rounded-2xl mb-6">
                    <h3 className="text-lg font-semibold text-purple-300 mb-2">🏘️ Where to Experience:</h3>
                    <p className="text-purple-300">{textileInfo[selectedTextile as keyof typeof textileInfo].villages}</p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      href="/destinations"
                      className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-full font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 hover:scale-105 shadow-lg"
                      onClick={() => setSelectedTextile(null)}
                    >
                    ...
                    <button
                      onClick={() => setSelectedTextile(null)}
                      className="bg-white/20 backdrop-blur-xl text-purple-100 px-6 py-3 rounded-full font-semibold hover:bg-white/20 backdrop-blur-xl transition-colors"
                    >
                      Close
                    </button>
                  </div>
