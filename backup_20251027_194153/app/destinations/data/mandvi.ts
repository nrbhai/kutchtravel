...
export const mandvi: Destination = {
  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        "<b><a href='/places/kashi-vishwanath' class='text-purple-300 hover:text-purple-300 underline'>Kashi Vishwanath Temple & Beach:</a></b> 5km - Serene secluded beach with Shiv temple nearby",
        "<b>Vijay Vilas Palace:</b> 8km - Royal palace with private beach and stunning architecture",
        "<b><a href='/places/asar-mata' class='text-purple-300 hover:text-purple-300 underline'>Asar Mata Temple & Beach:</a></b> 10-12km - Serene and secluded temple site with peaceful beach",
        "<b><a href='/places/ravalpir' class='text-purple-300 hover:text-purple-300 underline'>Ravalpir Temple & Beach:</a></b> 15km - Sacred temple rebuilt in 1819 with clean beach nearby",
        "<b>Shyamji Krishnavarma Memorial:</b> 3km - Kranti Tirth dedicated to the freedom fighter and scholar"
      ]
    },
    {
