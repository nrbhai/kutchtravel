        ...
        return (
          ...
          >
            ...
            >
              {/* Featured Badge */}
              {s.featured && (
                <div className={`absolute top-3 right-3 bg-gradient-to-r ${theme.colors.badges.primary} text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1 shadow-lg`}>
                  <Star size={10} />
                  Featured
                </div>
              )}
