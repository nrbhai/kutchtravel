            ...
            <li key={index} className="flex items-start">
              ...
              <div>
                {parsed.hasLink ? (
                  <Link 
                    href={parsed.href}
                    className="font-semibold text-purple-300 hover:text-purple-300 hover:underline transition-colors"
                  >
                    {parsed.title}
                  </Link>
                ) : (
                ...
                {parsed.description && (
                  <span className="text-purple-100 ml-2">- {parsed.description}</span>
                )}
              </div>
            </li>
          );
