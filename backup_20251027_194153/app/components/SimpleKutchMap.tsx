...
const SimpleKutchMap: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-80 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-xl border-2 border-emerald-300 overflow-hidden shadow-lg">
      {/* Background Map Image/Pattern */}
      <div className="absolute inset-0 opacity-20">
        <div 
          className="w-full h-full bg-emerald-200 rounded-xl"
          style={{
            backgroundImage: `
      ...
      <div className="absolute inset-4">
        <div className="relative w-full h-full">
          ...
          <div 
            className="absolute border-4 border-emerald-600 bg-emerald-50/50 rounded-lg"
            style={{
              left: '10%',
              top: '20%',
              width: '75%',
          ...
          />
          <div 
            className="absolute border-2 border-dashed border-emerald-500 rounded-lg opacity-60"
            style={{
              left: '8%',
              top: '18%',
              width: '79%',
      ...
      {/* Title Overlay */}
      <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-lg border border-emerald-200">
        <h5 className="font-inter font-bold text-sm text-emerald-700 mb-1">🗺️ Interactive Kutch Map</h5>
        <p className="text-xs text-purple-100">Click markers to explore destinations</p>
      </div>

      {/* Legend */}
      <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-lg border border-emerald-200">
        <h6 className="font-inter font-bold text-xs text-emerald-700 mb-2">Destinations</h6>
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-xs">
            <div className="w-2 h-2 bg-red-500 rounded-full"></div>
            <span className="text-purple-100">Heritage</span>
          </div>
          <div className="flex items-center gap-2 text-xs">
            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
            <span className="text-purple-100">Coastal</span>
          </div>
          <div className="flex items-center gap-2 text-xs">
            <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
            <span className="text-purple-100">Desert</span>
          </div>
        </div>
      </div>
    </div>
