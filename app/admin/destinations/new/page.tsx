...
export default function NewDestinationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/admin/destination', {
        method: 'POST',
      ...
      if (res.ok) {
        alert('Destination created successfully! Remember to commit your changes.');
        router.push('/admin');
        router.refresh();
      } else {
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Add New Destination</h1>
      </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
             ...
             <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Google Map Embed URL</label>
              <input
                required
                type="text"
