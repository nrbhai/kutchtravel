...
export const secretBirdingSite: HiddenGem = {
  ...
  coordinates: { lat: 23.47, lng: 68.83 }, // Approximate near Jakhau/Nalia
  bestTime: "November to March (Winter) - Early mornings are best",
  warnings: [
  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        "<b>Great Indian Bustard (GIB):</b> The star attraction. A large, ground-dwelling bird weighing up to 15kg. Sightings are extremely lucky.",
        "<b>Lesser Florican:</b> Another endangered bustard species found in the grasslands.",
    ...
    },
    {
      ...
      list: [
        "<b>Location:</b> ~20km from Nalia, ~110km from Bhuj.",
        "<b>Entry Fees:</b> Nominal entry fee charged by Forest Department (approx ₹50, subject to change).",
  ...
  facts: [
    "Size: ~2 sq km (Primary Zone)",
    "Status: Wildlife Sanctuary (1992)",
    "Key Species: Great Indian Bustard (GIB)",
    "Habitat: Grassland & Scrub",
    "GIB Status: Critically Endangered (<150 left globally)"
  ],
