...
export const metadata: Metadata = {
  title: 'Traditional Weaving - Handloom Textiles | Kutch Travel',
  description: 'Explore the vibrant weaving traditions of Kutch, where skilled weavers create beautiful shawls, stoles, and fabrics on traditional handlooms.',
};
...
export default function WeavingPage() {
  const craft = {
    ...
    sections: [
      ...
      {
        heading: "Mashroo - Silk-Cotton Blend",
        content: "Mashroo (meaning 'permitted' in Arabic) is a unique fabric developed for Islamic communities who weren't allowed to wear pure silk next to skin. The fabric is woven with silk warp and cotton weft, creating a silk-like sheen on one side while remaining cotton on the reverse. Traditional mashroo features vibrant stripes and is used for traditional garments. This complex weaving technique is now rare and highly valued."
      },
      {
        heading: "Tangaliya Shawls",
        content: "Tangaliya is a spectacular extra-weft weaving technique where colored threads are wrapped around warp threads to create a dotted pattern. Each dot is individually made by hand during the weaving process, making it extremely time-consuming. Traditional Tangaliya shawls feature geometric patterns in contrasting colors. A single shawl can take weeks to complete and is considered a masterpiece of weaving artistry."
      },
      {
        heading: "The Weaving Process",
        list: [
      ...
      {
        heading: "Natural Dyes & Colors",
        content: "Traditional weavers use natural dyes extracted from plants, minerals, and other natural sources. Indigo creates blue shades, madder root gives reds and pinks, pomegranate rind produces yellows, and iron creates blacks. The dyeing process is an art in itself, with recipes passed through generations. Natural dyes create softer, more organic colors compared to synthetic dyes and are eco-friendly and skin-safe."
      },
      {
        heading: "Kala Cotton - Black Gold",
        content: "Kala Cotton is an indigenous cotton variety grown organically in Kutch's arid lands. It's naturally resistant to pests and requires minimal water, making it perfectly suited to Kutch's climate. The cotton is brown-colored and has a beautiful, earthy texture. Fabrics woven from Kala Cotton are durable, breathable, and sustainable. This revival of indigenous cotton supports both traditional agriculture and weaving."
      },
      {
        heading: "Bhujodi - The Weaving Village",
        content: "Bhujodi village, just outside Bhuj, has become synonymous with quality handloom textiles. Nearly every household here has at least one loom, and the village echoes with the rhythm of weaving. The Vankar community has created a thriving textile center here, with cooperatives and individual workshops. Visitors can see weavers at work, understand the entire process, and purchase directly from artisans."
      },
      {
        heading: "Contemporary Adaptations",
        content: "Modern weavers are innovating while respecting tradition. They create contemporary designs - fusion wear combining traditional weaves with modern silhouettes, home décor items like cushion covers and table runners, and fashion accessories like scarves and stoles. Some collaborate with designers to create collections for urban and international markets. Despite modernization, the commitment to handloom quality remains unchanged."
      },
      {
        heading: "How to Identify Quality Handloom",
        list: [
      ...
      },
      {
        ...
        content: "Hand wash handloom fabrics in cold water with mild detergent, especially for the first few washes. Avoid wringing - gently squeeze out water. Dry in shade to preserve colors. Iron while slightly damp for best results. Fabrics with natural dyes may fade slightly over time, which adds to their character. Store in breathable cotton bags to prevent moisture damage."
      },
      {
        heading: "Price Range",
        content: "₹500 - ₹15,000 depending on technique, material, and complexity. Simple cotton stoles (₹500-1,200), wool shawls (₹1,500-4,000), Tangaliya shawls (₹3,000-8,000), Mashroo fabric (₹2,000-6,000 per meter), custom woven pieces (₹5,000-15,000), silk-blend items (premium pricing)."
      }
    ],
    
    artisanInfo: {
      villages: ["Bhujodi", "Dhamadka", "Khavda", "Kukma"],
      workshops: "Bhujodi is the primary center with dozens of weaving workshops. Most weavers work from home and welcome visitors. Shrujan and Khamir organizations in Bhuj showcase and sell quality handloom products. The Vankar community runs several cooperatives where you can see the entire weaving process from yarn preparation to finished fabric."
    },
