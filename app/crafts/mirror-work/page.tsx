...
export const metadata: Metadata = {
  title: 'Mirror Work (Shisha) - Traditional Embroidery | Kutch Travel',
...
export default function MirrorWorkPage() {
  const craft = {
    ...
    sections: [
      {
        heading: "Overview",
        content: "Mirror Work, known locally as 'Shisha' or 'Abhla Bharat', is one of Kutch's most distinctive embroidery traditions. This dazzling craft involves stitching small pieces of mirror or reflective material onto fabric using intricate embroidery stitches. The mirrors catch and reflect light, creating a sparkling, eye-catching effect that is synonymous with Gujarati textiles."
      },
      {
        heading: "History",
        content: "Mirror work embroidery has been practiced in Kutch for over 300 years. Originally, artisans used pieces of mica, a naturally reflective mineral, before glass mirrors became available. The tradition emerged among various communities including Rabari, Ahir, Mutwa, and Sodha Rajput women who adorned their clothing, bags, and household items with this technique. Each community developed distinctive patterns and color combinations."
      },
      {
        heading: "The Shisha Stitch Technique",
        content: "The mirrors are held in place using a unique 'shisha stitch' - a traditional method that has been passed down through generations. First, a framework of threads is created to hold the mirror. Then, decorative stitches (often chain stitch, herringbone, or buttonhole stitch) are worked around the edges to secure it permanently. The surrounding area is filled with colorful embroidery in traditional motifs."
      },
      {
        heading: "Traditional Communities & Styles",
        list: [
      ...
      {
        heading: "Common Motifs & Patterns",
        list: [
      ...
      },
      {
        ...
        list: [
          ...
          "Buy from women's cooperatives to directly support artisans",
          ...
          "Traditional pieces with antique mirrors are collector's items"
        ]
      },
      {
        heading: "Care & Maintenance",
        content: "Hand wash mirror work garments gently in cold water with mild detergent. Avoid wringing or twisting. Dry in shade to preserve colors. Iron on reverse side with cloth protection. Store in breathable cotton bags away from moisture. With proper care, mirror work pieces last for generations."
      },
      {
        heading: "Price Range",
        content: "₹300 - ₹30,000+ depending on size, intricacy, and authenticity. Small items like pouches (₹300-800), dupattas (₹1,500-5,000), traditional blouses (₹2,000-8,000), wall hangings (₹3,000-15,000), and bridal chaniya cholis (₹15,000-30,000+)."
      }
    ],
    
    artisanInfo: {
      villages: ["Bhujodi", "Khavda", "Hodka", "Dhamadka", "Nirona", "Ludiya"],
      workshops: "Visit women's craft centers and cooperatives in villages throughout Kutch. Many artisans work from home and welcome visitors. Shrujan in Bhuj is an excellent place to see high-quality traditional mirror work from various communities."
    },
