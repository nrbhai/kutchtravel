...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
      {/* Decorative Blobs */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-sky-500/10 to-cyan-500/10 rounded-full blur-3xl opacity-30"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-orange-500/10 rounded-full blur-3xl opacity-30"></div>
      
      {/* Decorative Top Border */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyan-900 via-sky-800 to-blue-900"></div>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              >
                ...
                <div className="flex flex-wrap gap-4">
                  <a 
                    ...
                    className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-500 hover:to-emerald-600 text-white px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 hover:scale-105 shadow-md"
                  >
                    💬 WhatsApp
                  </a>
                  <a 
                    href="tel:+919512234395" 
                    className="flex items-center gap-2 bg-gradient-to-r from-sky-600 to-blue-700 hover:from-sky-500 hover:to-blue-600 text-white px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 hover:scale-105 shadow-md"
                  >
                    📞 Call Now
                  </a>
                </div>
            ...
            <motion.div
              ...
              className="bg-black/40 backdrop-blur-sm rounded-3xl p-8 border border-white/10 shadow-lg"
            >
              <h4 className="text-2xl font-sora font-bold bg-gradient-to-r from-sky-400 to-blue-400 bg-clip-text text-transparent mb-6">Explore</h4>
            ...
            <motion.div
              ...
              className="bg-black/40 backdrop-blur-sm rounded-3xl p-8 border border-white/10 shadow-lg"
            >
              <h4 className="text-2xl font-sora font-bold bg-gradient-to-r from-cyan-400 to-orange-400 bg-clip-text text-transparent mb-6">Connect</h4>
              <div className="space-y-5 font-inter">
                ...
                <div className="flex items-start gap-3 text-gray-300">
                  ...
                  <div>
                    ...
                    <a href="tel:+919825034580" className="hover:text-indigo-400 transition-colors text-sm block">+91 98250 34580</a>
                    <a href="tel:+919512234395" className="hover:text-indigo-400 transition-colors text-sm block">+91 95122 34395</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 text-gray-300">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@travelkutch.org" className="hover:text-indigo-400 transition-colors text-sm">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-black/40 backdrop-blur-md rounded-3xl p-6 border border-white/10">
                <div className="w-full h-96 rounded-2xl overflow-hidden border border-white/20 shadow-2xl">
                  <iframe
