...
const NewKutchMap = () => {
  ...
  return (
    <div className="w-full h-80 bg-gradient-to-br from-gray-50 via-gray-50 to-gray-50 rounded-xl border-2 border-gray-300 relative overflow-hidden shadow-lg">
      
      {/* Map Background with Kutch Shape */}
      <div className="absolute inset-0 p-4">
        {/* Main Kutch Region Outline */}
        <div 
          className="absolute bg-gray-100 border-4 border-gray-600 rounded-lg opacity-80"
          style={{
            top: '10%',
            left: '10%',
            width: '80%',
        ...
        <div 
          className="absolute bg-gray-50 border-2 border-dashed border-gray-500 rounded-lg opacity-60"
          style={{
            top: '8%',
            left: '8%',
            width: '84%',
        ...
        {/* Region Labels */}
        <div className="absolute top-4 left-6 text-gray-700 font-bold text-sm opacity-60">
          Great Rann
        </div>
        <div className="absolute bottom-6 right-8 text-gray-300 font-bold text-sm opacity-60">
          Arabian Sea
        </div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-gray-800 font-bold text-lg opacity-40">
          KUTCH
        </div>
      </div>
      ...
      <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg p-3 shadow-lg">
        <h4 className="font-bold text-gray-100 text-xs mb-2">Legend</h4>
      ...
      {/* Destination Counter */}
      <div className="absolute top-4 right-4 bg-gradient-to-r from-gray-500 to-gray-500 text-white rounded-full px-3 py-1 text-xs font-bold shadow-lg">
